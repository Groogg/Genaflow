...
dag = DAG('%s_etl' % BANNER, default_args=default_args, schedule_interval='0 4 * * 5', catchup=False)
...
with dag:
    ...
    selenium_job = PythonOperator(
        ...
        python_callable=selenium.uni_selenium,
        op_kwargs={'folder_path': PATHS['download_report_folder'],
    ...
    transform_load = PythonOperator(
        ...
        python_callable=transform_load.uni_transform_load,
        op_kwargs={'folder_path': PATHS['download_report_folder'],
